        ...
        <Items>
            ...
            <px:PXTabItem Text="Manufacturing">
                <Template>
                    ...
                    <px:PXButton runat="server" ID="btnViewBOM" AlreadyLocalized="True" Style="min-width: 20px; width: 20px; border-style: none; padding-left: 0px; padding-right: 0px; height: 20px; padding-top: 0px; background-color: Transparent;">
                    ...
                    <px:PXButton runat="server" ID="btnViewPlanningBOM" AlreadyLocalized="True" Style="min-width: 20px; width: 20px; border-style: none; padding-left: 0px; padding-right: 0px; height: 20px; padding-top: 0px; background-color: Transparent;">
                        <Images Normal="main@RecordEdit" />
